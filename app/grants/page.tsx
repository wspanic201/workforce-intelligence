        ...
        <div className="max-w-[900px] mx-auto px-6 text-center">
          <AnimateOnScroll variant="fade-up">
            <div className="card-cosmic rounded-2xl p-8 md:p-10">
              ...
              <p className="mt-4 text-white/60 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
              ...
              <p className="mt-3 text-white/45 text-sm leading-relaxed max-w-xl mx-auto">
          ...
          <AnimateOnScroll variant="fade-up">
            <div className="card-cosmic rounded-2xl overflow-hidden">
              <div className="p-6 md:p-8 border-b border-white/[0.06]">
                <h3 className="text-xs font-medium uppercase tracking-widest text-white/70 mb-6">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { name: 'Regional Innovation Clusters (EDA)', score: 7.4, tag: 'Monitor', color: 'text-white/40', bg: 'bg-white/[0.02] border-white/[0.04]' },
                  ].map((g) => (
                    <div key={g.name} className={`flex items-center justify-between py-2.5 px-4 rounded-lg ${g.bg} border`}>
                      <div className="flex items-center gap-3 flex-wrap">
                        <span className="text-white/80 text-sm">{g.name}</span>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <span className="text-white/70 text-sm font-mono w-7 text-right">{g.score}</span>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <AnimateOnScroll variant="scale" delay={100}>
              <div className="card-cosmic rounded-2xl p-8 md:p-10 text-center border-green-500/20 h-full flex flex-col relative">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center rounded-full bg-gradient-to-r from-green-500 to-emerald-500 px-4 py-1 text-xs font-bold uppercase tracking-wider text-white shadow-lg shadow-green-500/20">
                    Founding Rate
                  </span>
                </div>
                <div className="mt-3">
                  <h3 className="font-heading font-bold text-white text-xl mb-2">Grant Intelligence Scan</h3>
                  <p className="text-white/70 text-sm mb-5">
                    30+ grants scanned, scored, and ranked for your institution.
                  </p>

                  <div className="mb-1">
                    <span className="font-heading font-bold text-4xl text-white">$495</span>
                    <span className="text-white/80 text-sm ml-2 line-through">$995</span>
                  </div>
                  <p className="text-white/80 text-xs mb-5">Founding rate — limited availability</p>
            ...
            <AnimateOnScroll variant="scale" delay={200}>
              <div className="card-cosmic rounded-2xl p-8 md:p-10 text-center border-white/10 h-full flex flex-col">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.06] border border-white/10 mb-5 mx-auto">
                  <Zap className="h-3.5 w-3.5 text-white/40" />
                  <span className="text-white/50 text-xs font-medium">Standard Pricing</span>
                </div>
                ...
                <div className="mb-5">
                  <span className="font-heading font-bold text-4xl text-white">$995</span>
                </div>
                ...
                <ul className="text-left max-w-xs mx-auto space-y-3 mb-7 flex-1">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-sm text-white/80">
                      <CheckCircle2 className="h-4 w-4 text-white/30 flex-shrink-0 mt-0.5" />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <StaggerChildren stagger={100} variant="fade-up" className="grid md:grid-cols-2 gap-6">
            ...
            <div className="card-cosmic rounded-2xl p-8 border-purple-500/20 flex flex-col">
              ...
              <h3 className="font-heading font-semibold text-white text-lg mb-1">Grant Application Package</h3>
            ...
            <div className="card-cosmic rounded-2xl p-8 border-teal-500/20 flex flex-col">
              ...
              <h3 className="font-heading font-semibold text-white text-lg mb-1">Grant Monitoring Retainer</h3>
          ...
          <StaggerChildren stagger={100} variant="fade-up" className="space-y-4">
            {[
              ...
              <Link key={name} href={href}>
                <div className="flex gap-4 p-5 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] hover:border-white/[0.08] transition-all cursor-pointer group">
                  <div className="w-10 h-10 rounded-lg bg-white/[0.05] flex items-center justify-center flex-shrink-0">
                    <span className="font-mono text-sm text-white/80">{stage}</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-heading font-semibold text-white text-sm group-hover:text-white/90 transition-colors">{name}</h3>
                      <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-white/[0.05] text-white/50">{tag}</span>
                    </div>
