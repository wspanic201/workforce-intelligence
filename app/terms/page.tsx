          ...
          <div className="prose-wavelength">
            ...
            <section className="mb-10">
              ...
              <ul className="text-theme-secondary leading-relaxed space-y-2 list-disc pl-6">
                <li><strong className="text-theme-primary">Program Opportunity Scans:</strong> Identification and analysis of potential workforce program opportunities based on labor market data</li>
                <li><strong className="text-theme-primary">Program Validation:</strong> In-depth validation of specific program concepts through market research and competitive analysis</li>
