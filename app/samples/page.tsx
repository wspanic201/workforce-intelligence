...
const services = [
  ...
  },
  {
    ...
    whatsInside: [
      '20+ federal, state, and foundation grants scanned',
      'Eligibility match score for each grant (High / Medium / Low)',
      'Award range and deadline for each opportunity',
      'Grant eligibility matrix (programs × grants)',
      'High-value unfunded opportunities ranked by ROI',
  ...
  },
  {
    ...
    whatsInside: [
      'Drift score by program (0–100; lower = more drift)',
      'Competency gap analysis: what you teach vs. what employers require',
      'Employer signal analysis from real job postings',
      'Certification and tool currency assessment',
      'Peer program benchmark comparison',
      'Prioritized curriculum update roadmap (immediate, next cycle, strategic)',
    ],
    value:
