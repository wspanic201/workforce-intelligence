...
const mainPrograms = [
  {
    ...
    demandEvidence: [
      'Duke University and Duke Health Systems (~43,000 employees) — largest employer in Durham County with consistent management hiring needs',
  ...
  },
  {
    ...
    opportunity: 'Research Triangle\'s advanced manufacturing and biotech sectors require specialized machinery maintenance with only one competitor. Novo Nordisk\'s $4.1B pharmaceutical expansion and Lenovo\'s ~5,000-employee manufacturing headquarters create immediate demand. Aligns with $25M Accelerate NC Life Sciences Manufacturing grant and existing Advanced Manufacturing workforce training.',
    demandEvidence: [
      ...
      'Lenovo (~5,000 employees) — North American headquarters in Morrisville with most of 5,000+ U.S. workers based in NC',
  ...
  },
  {
    ...
    opportunity: 'Research Triangle\'s tech sector and government contractors create critical regional need. Two existing providers focus on IT support rather than specialized cybersecurity. Cisco Systems (5,000+ employees) and Fidelity Investments (~8,000 employees with 15% growth) drive demand. Fast launch using existing Information and Digital Technology workforce training.',
    demandEvidence: [
      ...
      'Fidelity Investments (~8,000 employees) with significant growth since 2022 driven by technology positions',
  ...
  },
  {
    ...
    opportunity: 'Multiple trending certification mentions signal strong demand. Two existing providers serve construction and general manufacturing, but Research Triangle\'s advanced manufacturing (Novo Nordisk $4.1B, Lenovo ~5,000 employees) creates opportunity for specialized curriculum. Can differentiate with pharmaceutical/cleanroom welding and precision manufacturing focus.',
    demandEvidence: [
      ...
      'Lenovo (~5,000 employees) North American headquarters requiring precision manufacturing welding',
    ],
    competitiveLandscape: 'Competitive Advantage',
    metrics: {
      openings: '100–150',
