...
const mdContent = readFileSync('/Users/matt/.openclaw/workspace/ce-platform-ux-research.md', 'utf8')
  .replace(/^---[\s\S]*?---\n/, '');
...
<div class="cover">
  ...
  <div class="cover-domain">The future of CE registration</div>
  <div class="cover-eyebrow">UX Research Brief</div>
  <div class="cover-title">CE Platform<br>UX Research</div>
  <div class="cover-sub">Competitive UX audit, course page design spec, registration flow architecture, and mobile app patterns — everything needed to build the first modern continuing education registration platform.</div>
  ...
  <div class="cover-footer">Prepared by Cassidy · 6 platforms audited · Course page spec · Registration flow · Mobile UX patterns</div>
</div>
...
const outPath = '/Users/matt/Desktop/Encore-CE-Platform-UX-Research.pdf';
await page.pdf({
  path: outPath,
  format: 'A4',
