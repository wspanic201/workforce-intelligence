...
const mdContent = readFileSync('/Users/matt/projects/workforce-intelligence/ce-platform-research.md', 'utf8')
  .replace(/^---[\s\S]*?---\n/, '');
...
const outPath = '/Users/matt/Desktop/Wavelength-CE-Platform-Research.pdf';
await page.pdf({
  path: outPath,
  format: 'A4',
