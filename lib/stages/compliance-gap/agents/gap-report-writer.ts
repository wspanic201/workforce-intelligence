/**
 * State-Mandated Program Gap: Gap Analyzer + Report Writer Agent
 *
...
- Report type: State-Mandated Program Gap Analysis — state-mandated training programs not currently offered
