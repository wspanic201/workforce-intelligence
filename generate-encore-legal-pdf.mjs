...
const mdContent = readFileSync('/Users/matt/.openclaw/workspace/encore-legal-regulatory-landscape.md', 'utf8')
  .replace(/^---[\s\S]*?---\n/, '');
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  h1 {
    ...
    color: #1a1a2e; margin: 36px 0 12px;
    padding-bottom: 10px;
  ...
  h2 {
    ...
    color: #dc2626; margin: 28px 0 10px;
    page-break-after: avoid;
  }
  ...
  h4 {
    ...
    color: #3b82f6; margin: 14px 0 6px;
    page-break-after: avoid;
  }
...
<div class="cover">
  ...
  <div class="cover-title">Legal & Regulatory<br>Landscape</div>
  <div class="cover-subtitle">Compliance requirements, risk analysis, and recommended actions for the Encore CE registration platform</div>
...
const outputPath = '/Users/matt/Library/Mobile Documents/com~apple~CloudDocs/Businesses/Encore/Encore-Legal-Regulatory-Landscape.pdf';
