...
const mdContent = readFileSync('/Users/matt/.openclaw/workspace/encore-multitenant-architecture.md', 'utf8')
  .replace(/^---[\s\S]*?---\n/, '');
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .cover::before {
    ...
    background:
      radial-gradient(ellipse at 25% 25%, rgba(245,158,11,0.15) 0%, transparent 50%),
      radial-gradient(ellipse at 75% 75%, rgba(239,68,68,0.12) 0%, transparent 50%);
  }
  .cover-badge {
  ...
  h1 {
    ...
    color: #0c0f1e; margin: 36px 0 12px;
    padding-bottom: 10px;
  ...
  h2 {
    ...
    color: #b45309; margin: 28px 0 10px;
    page-break-after: avoid;
  }
  ...
  h3 {
    ...
    color: #0c0f1e; margin: 20px 0 8px;
    page-break-after: avoid;
  }

  h4 {
    font-size: 11px; font-weight: 600;
    color: #b45309; margin: 14px 0 6px;
    page-break-after: avoid;
  }
  ...
  strong { color: #0c0f1e; font-weight: 600; }
  ...
  blockquote p { margin: 0; color: #78350f; font-style: italic; }
  ...
  th {
    background: #0c0f1e; color: white; font-weight: 600;
...
<div class="cover">
  <div class="cover-badge">Encore Platform — Architecture Decision</div>
  <div class="cover-title">Multi-Tenant Architecture<br>Patterns & Decision</div>
  <div class="cover-subtitle">Shared DB vs. schema-per-tenant vs. DB-per-college — cost analysis at 10/50/200 colleges, FERPA analysis, and a clear recommendation with full implementation spec</div>
...
const outputPath = '/Users/matt/Library/Mobile Documents/com~apple~CloudDocs/Businesses/Encore/Encore-Multi-Tenant-Architecture.pdf';
